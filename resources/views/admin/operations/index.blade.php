            ...
            <div class="breadcrumb-main user-member justify-content-sm-between ">
                <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                    <div class="d-flex align-items-center user-member__title justify-content-center mr-sm-25">
                        <h4 class="text-capitalize fw-500 breadcrumb-title">Operations Management</h4>
                        <!-- <span class="sub-title ml-sm-25 pl-sm-25">274 Users</span> -->
                    </div>
                </div>
                <div class="action-btn d-flex">
                    @can('operation-create')
                    <a href="{{ route('operations.bulk-create') }}" class="btn px-15 btn-success">
                        <i class="las la-upload fs-16"></i>Upload Bulk Operations</a>
                    <a href="{{ route('operations.create') }}" class="btn px-15 btn-primary ml-3">
                        <i class="las la-plus fs-16"></i>Create New Operation</a>
                    @endcan
                </div>
            </div>
                    ...
                    <div id="filter-form-container" class="footable-filtering-external footable-filtering-right">
                        <form class="form-inline"  autocomplete="off">
                            ...
                            <div class="form-group d-flex align-items-center adv-table-searchs__position my-md-25 my-15 mr-sm-20 mr-0 ">
                                ...
                                <a href="{{ route('operations.index') }}" class="btn btn-light btn-sm btn-rounded"><span data-feather="refresh-cw"></span>
                                    Reset
                                </a>
                            </div>
                        </form>
                    ...
                    <table class="table mb-0 table-borderless">
                        <thead>
                            <tr class="userDatatable-header">
                                ...
                                <th>
                                    <span class="userDatatable-title">Operation ID</span>
                                </th>
                                <th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="orderDatatable_actions mb-0 d-flex flex-wrap"
                                        ...
                                        @can('operation-edit')
                                        <li>
                                            <a href="{{ route('operations.edit', $oprtn->id) }}" title="Edit Operation" class="edit"> <span data-feather="edit"></span></a>
                                        </li>
                                        @endcan

                                        @can('operation-delete')
                                        <li>
                                            <a href="#" class="remove deleteOperation" data-id="{{$oprtn->id}}"
                                                title="Delete Operation"> <span data-feather="trash-2"></span></a>
                                        </li>
                                        @endcan
                                    </ul>
                                </td>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response == 1){
                        ...
                        swal.fire("Failed!", "Operation already assigned to a job card.", "error");
                    }
                },
