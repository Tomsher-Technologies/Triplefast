            ...
            <div class="breadcrumb-main user-member justify-content-sm-between ">
                <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                    <div class="d-flex align-items-center user-member__title justify-content-center mr-sm-25">
                        <h4 class="text-capitalize fw-500 breadcrumb-title">Customer Management</h4>
                        <!-- <span class="sub-title ml-sm-25 pl-sm-25">274 Users</span> -->
                    </div>
                </div>
                <div class="action-btn d-flex">
                    @can('customer-create')
                    <a href="{{ route('customer.bulk-create') }}" class="btn px-15 btn-success">
                        <i class="las la-upload fs-16"></i>Upload Bulk Customers</a>
                    <a href="{{ route('customer.create') }}" class="btn px-15 btn-primary ml-3">
                        <i class="las la-plus fs-16"></i>Create New Customer</a>
                    @endcan
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="userDatatable global-shadow border p-10 bg-white radius-xl w-100 mb-30">
                ...
                <div class="alert-big alert alert-warning  alert-dismissible fade show alert-important" role="alert">
                    <div class="alert-icon">
                        <span data-feather="layers"></span>
                    </div>
                    <div class="alert-content">
                    ...
                    <div id="filter-form-container" class="footable-filtering-external footable-filtering-right">
                        <form class="form-inline"  autocomplete="off">
                            ...
                            <div class="form-group d-flex align-items-center adv-table-searchs__position my-md-25 my-15 mr-sm-20 mr-0 ">
                                ...
                                <a href="{{ route('customer.index') }}" class="btn btn-light btn-sm btn-rounded"><span data-feather="refresh-cw"></span>
                                    Reset
                                </a>
                            </div>
                        </form>
