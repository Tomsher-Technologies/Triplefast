        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Update Customer</h4>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        <div class="mx-sm-30 mx-20 ">
                            ...
                            {!! Form::model($customer, ['method' => 'PATCH','class' => 'form-horizontal repeater','autocomplete' => 'off','route' => ['customer.update', $customer->id]]) !!}
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="add-product__body px-sm-40 px-20">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="customer_id" name="customer_id" placeholder="Enter Customer ID" value="{{ old('customer_id', $customer->custom_id) }}">
                                                @error('customer_id')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="name1">Status<span class="required">*</span></label>
