    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="breadcrumb-main">
                <h4 class="text-capitalize breadcrumb-title">Update Operation</h4>
                            ...
                            <div class="card add-product p-sm-30 p-20 mb-30">
                                <div class="card-body p-0">
                                    ...
                                    <div class="add-product__body px-sm-40 px-20">
                                        <!-- Start: form -->
                                        {!! Form::model($operation, ['method' => 'PATCH','autocomplete' => 'off','route' => ['operations.update', $operation->id]]) !!}
                                            @csrf
                                            <!-- form group -->
                                            <div class="form-group">
                                                <label for="name1">Operation ID<span class="required">*</span></label>
                                                <input type="text" class="form-control" id="operation_id" name="operation_id" placeholder="Enter Operation ID" value="{{ old('operation_id',$operation->operation_id) }}">
                                                @error('operation_id')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="description" name="description" placeholder="Enter Description" value="{{ old('description', $operation->description) }}">
                                                @error('description')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="is_active" name="is_active">
                                                    <option value="1" @if(old('is_active',$operation->is_active) == 1) selected @endif>Active</option>
                                                    <option value="0" @if(old('is_active',$operation->is_active) == 0) selected @endif>Inactive</option>
                                                </select>
                                                @error('is_active')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
